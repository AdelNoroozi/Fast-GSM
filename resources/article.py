...
from managers import ArticleManager, oauth2_scheme, is_observer
...
@router.post("/articles/", status_code=201, response_model=RetrieveArticleModel, dependencies=[Depends(oauth2_scheme)])
